...
/**
 * <p>Clase Java para errorMessageType complex type.
 * 
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="reason" type="{http://ea.assurance.bnpparibas.com/internal/schema/lam/common/exception/v1}errorMessageType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlSeeAlso({
    TechnicalBaseFaultType.class,
    FunctionalBaseFaultType.class
})
public class ErrorMessageType {
    ...
    @XmlElement(required = true)
    protected ErrorMessageType.Reasons reasons;
    @XmlElement(required = true)
    protected ErrorMessageType.Params params;
     ...
     * @return
     *     possible object is
     *     {@link ErrorMessageType.Reasons }
     *     
     */
    public ErrorMessageType.Reasons getReasons() {
        return reasons;
    }
     ...
     *     
     */
    public void setReasons(ErrorMessageType.Reasons value) {
        this.reasons = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link ErrorMessageType.Params }
     *     
     */
    public ErrorMessageType.Params getParams() {
        return params;
    }
     ...
     *     
     */
    public void setParams(ErrorMessageType.Params value) {
        this.params = value;
    }
    ...
    public static class Params {
        ...
        protected List<ErrorMessageType.Params.Param> param;
         ...
         * {@link ErrorMessageType.Params.Param }
         * 
         * 
         */
        public List<ErrorMessageType.Params.Param> getParam() {
            if (param == null) {
                param = new ArrayList<ErrorMessageType.Params.Param>();
            }
            return this.param;
        }
    ...
    public static class Reasons {
        ...
        protected List<ErrorMessageType> reason;
         ...
         * 
         */
        public List<ErrorMessageType> getReason() {
            if (reason == null) {
                reason = new ArrayList<ErrorMessageType>();
            }
            return this.reason;
        }
